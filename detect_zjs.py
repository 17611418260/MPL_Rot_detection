...
parser.add_argument('--data', type=str, default='/data/chenghanjia/yolov8/jch/cocotest.yaml', help='dataset.yaml path')
parser.add_argument('--source', type=str, default='/data/chenghanjia/yolov8/datasets/TGRS-HRRSD/images/test/')
#/data/chenghanjia/yolov8/datasets/draw_temp/img
#/data/chenghanjia/yolov8/datasets/TGRS-HRRSD/images/test
# parser.add_argument('--epochs', type=int, default=800, help='number of epochs')
parser.add_argument('--hyp', type=str, default='/data/chenghanjia/yolov8/jch/hyp.yaml', help='size of each image batch')
#parser.add_argument('--model', type=str, default='/data/chenghanjia/yolov8/yolo/yolov8_mpl_conf0.8_finlabel_4set_epoch9002/weights/best.pt', help='pretrained weights or model.config path') 
parser.add_argument('--model', type=str, default='/data/jingshengzeng/Rot_obj_det/yolo/yolov8_pl2/weights/best.pt', help='pretrained weights or model.config path')    #TODO
# /data/chenghanjia/yolov8/jch/yolov8x.pt
# /data/chenghanjia/yolov8/yolo/pretrain_nodot_conf0.7/weights/yolov8x.pt
# /data/chenghanjia/yolov8/yolo/yolov8_mpl_conf0.8_finlabel_4set_epoch9002/weights/best.pt  #todo:ours
# /data/chenghanjia/yolov8/yolo/teacher_model_pretrain/TGRS_yolov8_org/weights/best.pt #todo:yolov8
...
parser.add_argument('--name', type=str, default='org/test', help='exp name') # pretrain
parser.add_argument('--resume', nargs='?', const=True, default=False, help='resume most recent training')
# parser.add_argument('--teacher-warmup',type=int, default=0, help='教师网络预热轮数')
# parser.add_argument('--teacher-model', type=str, default='/data/chenghanjia/yolov8/yolo/teacher_model_pretrain/TGRS_yolov8_org/weights/best.pt', help='教师网络预热权重')
...
# parser.add_argument('--close-mosaic', default=80, type=float, help='the epoch when close mosaic argument')
...
if __name__ == '__main__':
    ...
    # model.predict(source= args.source, save=True, **hyperparams)     #出图
    model.val(data= args.data, **hyperparams)                 #出指标
